...
display.func <- function(N_advance){
 ...
 #   labs(title = paste0("LU Observed vs. Fitted Monthly Incidence", N_advance))
  ...
  filter(date == (as.Date('2006-12-01' ) %m+% months(N_advance))) %>%
  mutate(mae = abs(monthly_inc - fitted_inc))
  saveRDS(mae_df, paste0("Data_5/ppt2_MAE_df", N_advance, ".rds"))
...
mae_merged_df <- do.call(rbind, 
                         lapply(list.files('/Users/zoe/Documents/Yale EMD/Rotation 1/Dengue - Vietnam/dengue_exploration/Data_5', 
