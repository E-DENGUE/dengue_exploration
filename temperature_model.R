...
mod.func <- function(N_advance) {
  ...
  x_model <- cbind(x_model_1, ds$rh, ds$lag_1_rh, ds$lag_2_rh, ds$lag_3_rh, ds$lag_4_rh, ds$lag_5_rh, ds$lag_6_rh)
  ...
  # save to a file
  saveRDS(post_fit_temp, paste0("post_fit_temp2_", N_advance,".rds"))
