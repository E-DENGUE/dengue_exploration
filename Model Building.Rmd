...
print(mod1)
mod1_2$fitted.values # PROBLEM = Inf
...
########## mod1_2 ###################
# prior tau of 0.10 and 5000 burnin --> went 100%

beta_samples_mod1_2 <-mod1_2$samples$beta
plot(beta_samples_mod1_2[1,], type='l', col='red',main="beta") # First chain
lines(beta_samples_mod1_2[2,],col='blue')
lines(beta_samples_mod1_2[3,], col = "green")
lines(beta_samples_mod1_2[4,], col = "orange")
lines(beta_samples_mod1_2[5,], col = "yellow")
lines(beta_samples_mod1_2[6,], col = "purple")
lines(beta_samples_mod1_2[7,], col = "firebrick1")
lines(beta_samples_mod1_2[8,], col = "dodgerblue1")
lines(beta_samples_mod1_2[9,], col = "darkolivegreen1")
lines(beta_samples_mod1_2[10,], col = "darkorange3")
lines(beta_samples_mod1_2[11,], col = "goldenrod2")
lines(beta_samples_mod1_2[12,], col = "darkorchid1")

betas_mod1_2 <- data.frame(m1 = mod1_2$samples$beta[,1], m2 = mod1_2$samples$beta[,2], 
                           m3 = mod1_2$samples$beta[,3], m4 = mod1_2$samples$beta[,4], 
                           m5 = mod1_2$samples$beta[,5], m6 = mod1_2$samples$beta[,6], 
                           m7 = mod1_2$samples$beta[,7], m8 = mod1_2$samples$beta[,8], 
                           m9 = mod1_2$samples$beta[,9], m10 = mod1_2$samples$beta[,10], 
                           m11 = mod1_2$samples$beta[,11], m12 = mod1_2$samples$beta[,12])
library(ggplot2)
library(viridis)
library(dplyr)
ggplot(betas_mod1_2)+
  geom_density(aes(betas_mod1_2[,1]), fill = 'red', color = 'red')+
  geom_density(aes(betas_mod1_2[,2]), fill = 'blue', color = 'blue')+
  geom_density(aes(betas_mod1_2[,3]), fill = 'green', color = 'green')+
  geom_density(aes(betas_mod1_2[,4]), fill = 'orange', color = 'orange')+
  geom_density(aes(betas_mod1_2[,5]), fill = 'yellow', color = 'yellow')+
  geom_density(aes(betas_mod1_2[,6]), fill = 'purple', color = 'purple')+
  geom_density(aes(betas_mod1_2[,7]), fill = 'firebrick1', color = 'firebrick1')+
  geom_density(aes(betas_mod1_2[,8]), fill = 'dodgerblue1', color = 'dodgerblue1')+
  geom_density(aes(betas_mod1_2[,9]), fill = 'darkolivegreen1', color = 'darkolivegreen1')+
  geom_density(aes(betas_mod1_2[,10]), fill = 'darkorange3', color = 'darkorange3')+
  geom_density(aes(betas_mod1_2[,11]), fill = 'goldenrod2', color = 'goldenrod2')+
  geom_density(aes(betas_mod1_2[,12]), fill = 'darkorchid1', color = 'darkorchid1')+
  geom_vline(xintercept = 0, color = "red", size = 1, linetype = 3)+
   labs(title = "Posterior distribution of the month coefficients", x = "Beta", y = "Density")

## plot fitted vs. real values of DHF cases
ds_mod1$mod1_2_fitted <- mod1_2$fitted.values
ds_mod1$mod1_2_resid <- mod1_2$residuals$response
