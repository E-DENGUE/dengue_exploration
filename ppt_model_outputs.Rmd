---
title: "Precipitation Model Outputs"
...
display.func <- function(N_advance){
  ...
  # model output
  ppt_fit <- readRDS(paste0("ppt_model_outputs/post_fit_ppt_", N_advance, ".rds"))
  ...
  filter(date == (as.Date('2006-12-01' ) %m+% months(N_advance))) %>%
  mutate(mae = abs(monthly_inc - fitted_inc))
  saveRDS(mae_df, paste0("Data_3/ppt_MAE_df", N_advance, ".rds"))
...
saveRDS(mae_merged_df, "ppt_model_mae.rds")
...
MAE_full <- readRDS("ppt_model_mae.rds")
